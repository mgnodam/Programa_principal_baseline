...
shared = dict(
    ...
    distance_km      = 463, # Distância geográfica da rota de estudo, medida em quilômetros. Se o modelo usa milhas náuticas internamente, converte-se por 1 nm = 1,852 km.
                            # Serve para estimar consumo e para dividir custos de viagem.
    usd_per_brl      = 0.18,# Taxa de câmbio utilizada para converter custos cotados em reais (BRL) para dólares americanos (USD), unidade tradicional nos estudos DOC de Roskam.
...
inputs = {
    ...
    "flight": dict(
        ...
        combustivel_usado             = 770.8,                  # Quantidade de combustível usado na missão (lbs) - 150 NM : 560 lbs / 250 nm : 770.8 NM  lbs / 500 NM : 1298  lbs
        ...
        taxa_seguro                   = 0.025,                  # Taxa  de seguro baseado em percentagem do valor de aquisição da aeronave - valor  2.5 % por ser monomotor [Ian]
    ),
