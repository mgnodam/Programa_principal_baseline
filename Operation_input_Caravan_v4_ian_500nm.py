...
shared = dict(
    ...
    distance_km      = 926, # Distância geográfica da rota de estudo, medida em quilômetros. Se o modelo usa milhas náuticas internamente, converte-se por 1 nm = 1,852 km.
...
inputs = {
    ...
    "flight": dict(
        ...
        combustivel_usado             = 1300,                  # Quantidade de combustível usado na missão (lbs) - 150 NM : 560 lbs / 250 nm : 770.8  lbs / 500 NM : 1300  lbs
