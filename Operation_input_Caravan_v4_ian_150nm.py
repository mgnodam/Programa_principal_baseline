...
shared = dict(
    ...
    distance_km      = 278, # Distância geográfica da rota de estudo, medida em quilômetros. Se o modelo usa milhas náuticas internamente, converte-se por 1 nm = 1,852 km.
...
inputs = {
    ...
    "flight": dict(
        ...
        combustivel_usado             = 560,                  # Quantidade de combustível usado na missão (lbs) - 150 NM : 560 lbs / 770.8 NM : xxx lbs / 500 NM : 1298  lbs
